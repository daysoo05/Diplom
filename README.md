...
This project monitors climate changes using public servers (ERA5 via Copernicus CDS), preprocesses it, trains a simple forecasting model, and offers a Streamlit dashboard.
...
- If you want, I can:
  - Push these files to a branch in your daysoo05/Diplom (or create files in a branch) with the prototypes above, CI to run tests, and a simple notebook. Tell me if you want this and confirm repository and branch details.
